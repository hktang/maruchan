<?php
/**
 * maruchan functions and definitions
 *
 * @package maruchan
 */
...
if ( ! function_exists( 'maruchan_setup' ) ) :
/**
 ...
 */
function maruchan_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on maruchan, use a find and replace
	 * to change 'maruchan' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'maruchan', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'maruchan' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'maruchan_custom_background_args', array(
 ...
 */
function maruchan_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'maruchan' ),
		'id'            => 'sidebar-1',
...
add_action( 'widgets_init', 'maruchan_widgets_init' );
